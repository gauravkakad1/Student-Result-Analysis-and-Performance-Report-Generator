...
from a import *
abc(5)
fname = "2019PatternResult.pdf"
def Convert_extract_data(fname) :
    
    #reading pdf file
    with open(fname, "rb") as pdfFile:
        ...
        for line in lines:
            if (
                ...
                if not line.startswith("."):
                    line = re.sub(r"\s{2,}", ",", line) #replace multiple spaces by comma
            ...
            if "SEAT NO." in row:
                ...
                with open("SampleFile.txt", "a") as f :
                    f.write(seat_no + "," + name + "," + sgpa + "," 
                            + dm_ise + "," + dm_ese + "," + dm_total + "," + dm_tot_per + "," + dm_grd + "," 
